...
import { loadPlugins, pluginStore } from "./src/lib/vemzo-plugins.js";
import { initDatabase, getDatabase } from "./src/lib/vemzo-database.js";
import {
  initScheduler,
  loadScheduledMessages,
  startGroupScheduleChecker,
  startSewaChecker,
} from "./src/lib/vemzo-scheduler.js";
import { handleAntiTagSW } from "./src/lib/vemzo-group-protection.js";
import { initSholatScheduler } from "./src/lib/vemzo-sholat-scheduler.js";
import { initNotifScheduler } from "./src/lib/vemzo-notif-scheduler.js";
import { initAutoJpmScheduler } from "./src/lib/vemzo-auto-jpm.js";
import { startMemoryMonitor } from "./src/lib/vemzo-memory-monitor.js";
import { startTempCleaner } from "./src/lib/vemzo-temp-cleaner.js";
import { startDailyPruner } from "./src/lib/vemzo-data-pruner.js";
import { preloadAssets } from "./src/lib/vemzo-asset-manager.js";
import {
  logger,
  c,
  playBootSequence,
  ...
  logErrorBox,
  divider,
} from "./src/lib/vemzo-logger.js";

await import("./src/lib/vemzo-agent.js")
    ...
    (eventType, filename) => {
      ...
      const timeout = setTimeout(async () => {
        ...
        if (!fs.existsSync(fullPath)) {
          ...
          const { unloadPlugin } = await import("./src/lib/vemzo-plugins.js");
        ...
        try {
          ...
          const { hotReloadPlugin } =
            await import("./src/lib/vemzo-plugins.js");
  ...
  await startConnection({
    ...
    onConnectionUpdate: async (update, sock) => {
      if (update.connection === "open") {
        ...
        try {
          const { initAutoStart } = await import("./src/lib/vemzo-auto-anime.js");
          initAutoStart(sock);
        } catch (e) {
          logger.error("AUTOANIME", `Gagal restore: ${e.message}`);
        }
        ...
        try {
          const { startOtpPoller: _startOtp } =
            await import("./src/lib/vemzo-otp-poller.js");
          _startOtp(sock);
        } catch { }

        try {
          const { getAllJadibotSessions, restartJadibotSession } =
            await import("./src/lib/vemzo-jadibot-manager.js");
